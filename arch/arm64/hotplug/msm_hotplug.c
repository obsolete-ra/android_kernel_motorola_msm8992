...
module_param_named(debug_mask, debug, uint, 00644);
...
static DEVICE_ATTR(msm_enabled, 00644, show_enable_hotplug, store_enable_hotplug);
static DEVICE_ATTR(lock_duration, 00644, show_lock_duration,
		   store_lock_duration);
